...
;(function ($) {
  $.fn.spinner = function (opts) {
    return this.each(function () {
      ...
      var increaseButton = $('<button class="increase">+</button>').on("click",(function () { changeValue(1) }))
      var decreaseButton = $('<button class="decrease">-</button>').on("click",(function () { changeValue(-1) }))
